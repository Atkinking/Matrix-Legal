...
class RealDigitalIdentityResearch:
    ...
    def _create_test_image(self, image_path):
        ...
        try:
            # Skapa en enkel testbild med rätt format
            img = np.random.randint(0, 255, (300, 300, 3), dtype=np.uint8)
            
            # Lägg till en enkel form som kan detekteras som ansikte
            cv2.rectangle(img, (100, 100), (200, 200), (128, 128, 128), -1)  # Ansikte
            cv2.circle(img, (130, 130), 10, (0, 0, 0), -1)  # Vänster öga
            cv2.circle(img, (170, 130), 10, (0, 0, 0), -1)  # Höger öga
            cv2.rectangle(img, (140, 160), (160, 180), (0, 0, 0), -1)  # Näsa
            cv2.rectangle(img, (120, 190), (180, 200), (0, 0, 0), -1)  # Mun
            
            # Spara med rätt filändelse
        ...
        try:
            ...
            for row in cursor.fetchall():
                ...
                history.append({
                    ...
                    'best_similarity': results.get('best_overall_match', {}).get('similarity_score', 0) if results.get('best_overall_match') else 0
                })
    ...
    try:
        ...
        if choice == "1":
            ...
            try:
                ...
                if results.get('best_overall_match'):
